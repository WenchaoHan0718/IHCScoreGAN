...
import re
import sys
from preprocessing import util, mask
from preprocessing.util import Time

# SRC_DIR = 'C:\\Users\\M306410\\Downloads\\TCGA\\40x'
SRC_DIR = 'results'
# BASE_DIR = os.path.join(os.sep, "Volumes", "BigData", "TUPAC")
TRAIN_PREFIX = ""
SRC_TRAIN_DIR = os.path.join(SRC_DIR, "slides")
SRC_ANNOT_DIR = os.path.join(SRC_DIR, "annotations")
...
# DEST_DIR = 'C:\\Users\\M306410\\Downloads\\TCGA\\preprocessing'
DEST_DIR = 'results'
DEST_TRAIN_DIR = os.path.join(DEST_DIR, "training_" + DEST_TRAIN_EXT)
DEST_TRAIN_THUMBNAIL_DIR = os.path.join(DEST_DIR, "training_thumbnail_" + THUMBNAIL_EXT)

FILTER_SUFFIX = ""  # Example: "filter-"
FILTER_RESULT_TEXT = "filtered"
FILTER_DIR = os.path.join(DEST_DIR, "filter_" + DEST_TRAIN_EXT)
FILTER_THUMBNAIL_DIR = os.path.join(DEST_DIR, "filter_thumbnail_" + THUMBNAIL_EXT)
FILTER_PAGINATION_SIZE = 100
FILTER_PAGINATE = True
FILTER_HTML_DIR = DEST_DIR

TILE_SUMMARY_DIR = os.path.join(DEST_DIR, "tile_summary_" + DEST_TRAIN_EXT)
TILE_SUMMARY_ON_ORIGINAL_DIR = os.path.join(DEST_DIR, "tile_summary_on_original_" + DEST_TRAIN_EXT)
TILE_SUMMARY_SUFFIX = "tile_summary"
TILE_SUMMARY_THUMBNAIL_DIR = os.path.join(DEST_DIR, "tile_summary_thumbnail_" + THUMBNAIL_EXT)
TILE_SUMMARY_ON_ORIGINAL_THUMBNAIL_DIR = os.path.join(DEST_DIR, "tile_summary_on_original_thumbnail_" + THUMBNAIL_EXT)
TILE_SUMMARY_PAGINATION_SIZE = 100
TILE_SUMMARY_PAGINATE = True
TILE_SUMMARY_HTML_DIR = DEST_DIR

TILE_DATA_DIR = os.path.join(DEST_DIR, "tile_data")
TILE_DATA_SUFFIX = "tile_data"

TOP_TILES_SUFFIX = "top_tile_summary"
TOP_TILES_DIR = os.path.join(DEST_DIR, TOP_TILES_SUFFIX + "_" + DEST_TRAIN_EXT)
TOP_TILES_THUMBNAIL_DIR = os.path.join(DEST_DIR, TOP_TILES_SUFFIX + "_thumbnail_" + THUMBNAIL_EXT)
TOP_TILES_ON_ORIGINAL_DIR = os.path.join(DEST_DIR, TOP_TILES_SUFFIX + "_on_original_" + DEST_TRAIN_EXT)
TOP_TILES_ON_ORIGINAL_THUMBNAIL_DIR = os.path.join(DEST_DIR,
                                                   TOP_TILES_SUFFIX + "_on_original_thumbnail_" + THUMBNAIL_EXT)

TILE_DIR = os.path.join(DEST_DIR, "tiles_" + DEST_TRAIN_EXT)
TILE_SUFFIX = "tile"

STATS_DIR = os.path.join(DEST_DIR, "svs_stats")
...
def get_training_mask(slide_number):
  padded_sl_num = str(slide_number).zfill(3)
  msk_path = os.path.join(SRC_MASK_DIR, padded_sl_num + '.npy')
  msk = Image.fromarray(np.load(msk_path))
...
def get_filter_image_result(slide_number, dimensions=None):
  """
  ...
  if dimensions is None:
    training_img_path = get_training_image_path(slide_number)
    large_w, large_h, small_w, small_h = parse_dimensions_from_image_filename(training_img_path)
  else: large_w, large_h, small_w, small_h = dimensions
...
def slide_to_scaled_pil_image(slide_number, training_slide_path=None):
  """
  ...
  """
  slide_filepath = get_training_slide_path(slide_number) if training_slide_path is None else training_slide_path
