...
from segmentation.misc.patch_extractor import PatchExtractor
from segmentation.misc.utils import rm_n_mkdir

from segmentation.dataset import get_dataset
...
if __name__ == "__main__":
    ...
    # This used to get the specific dataset img and ann loading scheme from segmentation.dataset.py
    dataset_name = "consep"
