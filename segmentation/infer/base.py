...
from segmentation.run_utils.utils import convert_pytorch_checkpoint
...
class InferManager(object):
    ...
    def __load_model(self):
        ...
        """
        model_desc = import_module("segmentation.models.hovernet.net_desc")
        ...
        module_lib = import_module("segmentation.models.hovernet.run_desc")
        run_step = getattr(module_lib, "infer_step")
        self.run_step = lambda input_batch: run_step(input_batch, net)

        module_lib = import_module("segmentation.models.hovernet.post_proc")
